...
<div class="text-center module-client-area">
    <link href="modules/servers/templates/cloudstack/css/style.css" rel="stylesheet" type="text/css">
                                ...
                                <form method="post" action="clientarea.php?action=productdetails&id={$serviceid}">
                                    ...
                                    <table style="width:100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td><label>
                                                    <select name="serviceoffer" class="form-control">
                                                            {$serviceoffer}
                                                        </select>
                                                </label>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <label>
                                                    <select name="diskoffer" class="form-control">
                                                            {$diskoffer}
                                                    </select>
                                                </label>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <label>
                                                    <input type="text" class="form-control" name="domainname" placeholder="">
                                                </label>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <label>
                                                    <input type="text" class="form-control" name="prefix" placeholder="Example: EXAMPLE">
                                                </label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td>
                                                <input type="submit" name="submit" class="btn btn-default" value="Build  VM!">
                                            </td>
                                        </tr>
                                    </table>
                                </form>
